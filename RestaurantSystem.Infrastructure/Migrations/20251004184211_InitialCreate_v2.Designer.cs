...
namespace RestaurantSystem.Infrastructure.Migrations
{
    ...
    [Migration("20251004184211_InitialCreate_v2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantSystem.Core.Entities.CustomerInvoiceItem", b =>
                {
                    ...
                    b.Property<long?>("CustomerInvoiceItemId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("CustomerInvoiceItemId");
            ...
            modelBuilder.Entity("RestaurantSystem.Core.Entities.CustomerInvoiceItem", b =>
                {
                    b.HasOne("RestaurantSystem.Core.Entities.CustomerInvoiceItem", null)
                        .WithMany("CustomerInvoiceItems")
                        .HasForeignKey("CustomerInvoiceItemId");
